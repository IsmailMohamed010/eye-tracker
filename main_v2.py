...
def gaze_tracking(blinking_rate,right_rate,center_rate):
    ...
    frames_to_blink=9 #  if we blink 12 frames --> choose this letter
        ...
        for face in faces :
            ...
            if blinking_frames==0:    
                ...
                if gaze_ratio<=right_rate:
                    ...
                    if keyboard_selection_frames == 8:
...
blinking_ratio=4.9  # increase --> must close your eyes more

right_ratio_down_from=0.61 # ratio of how ratio you want to detect looking right, increase --> more bias to right
left_ratio_start_from=3.38 # ratio of how ratio you want to detect looking right, decrease --> more bias to left
